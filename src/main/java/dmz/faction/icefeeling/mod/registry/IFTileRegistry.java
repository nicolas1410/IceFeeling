...
public class IFTileRegistry {
	...
	/*------------------------------------------------------ TILE ENTITIES ------------------------------------------------------*/
	/* IRON FURNACE ------------------------------------------------------ */
	public static final RegistryObject<TileEntityType<IFIronFurnaceTileEntity>> IRON_FURNACE_TILE = TILES.register(
			"iron_furnace", () -> TileEntityType.Builder.of(IFIronFurnaceTileEntity::new, IFBlocks.IRON_FURNACE.get()).build(null));
	...
	public static final RegistryObject<TileEntityType<IFObsidianFurnaceTileEntity>> OBSIDIAN_FURNACE_TILE = TILES
			.register("obsidian_furnace_tile", () -> TileEntityType.Builder
					.of(IFObsidianFurnaceTileEntity::new, IFBlocks.OBSIDIAN_FURNACE.get()).build(null));
	/* SINGLE ITEM CHEST ------------------------------------------------------ */
	...
	public static final RegistryObject<TileEntityType<IFCommonItemFilterTile>> COMMON_ITEM_FILTER_TILE = TILES
			.register("common_item_filter_tile", () -> TileEntityType.Builder
					.of(IFCommonItemFilterTile::new, IFBlocks.COMMON_ITEM_FILTER.get()).build(null));

	/* TRASH CAN ------------------------------------------------------ */

	public static final RegistryObject<TileEntityType<IFTrashCanTileEntity>> TRASH_CAN_TILE = TILES.register(
			"trash_can_tile",
			() -> TileEntityType.Builder.of(IFTrashCanTileEntity::new, IFBlocks.TRASH_CAN.get()).build(null));
	...
	public static final RegistryObject<TileEntityType<IFSingleItemChestTile>> SINGLE_ITEM_CHEST_TILE_BIG = TILES
			.register("single_item_chest_tile_big", () -> TileEntityType.Builder
					.of(IFSingleItemChestTile::new, IFBlocks.SINGLE_ITEM_CHEST_BIG.get()).build(null));
