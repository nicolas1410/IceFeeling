package dmz.faction.icefeeling.tileentity.base;
...
import dmz.faction.icefeeling.blocks.IFFurnaceBlock;
...
public abstract class IFFurnaceTileEntity extends IFTileEntityInventory
	...
	public final IIntArray furnaceData = new IIntArray() {
	      public int get(int index) {
	         switch(index) {
	         case 0:
	            return IFFurnaceTileEntity.this.burnTime;
	         case 1:
	            return IFFurnaceTileEntity.this.recipesUsed;
	         case 2:
	            return IFFurnaceTileEntity.this.cookTime;
	         case 3:
	            return IFFurnaceTileEntity.this.cookTimeTotal;
	         default:
	            return 0;
	         }
	      }
	      ...
	      public void set(int index, int value) {
	         switch(index) {
	         case 0:
	        	 IFFurnaceTileEntity.this.burnTime = value;
	            break;
	         case 1:
	        	 IFFurnaceTileEntity.this.recipesUsed = value;
	            break;
	         case 2:
	        	 IFFurnaceTileEntity.this.cookTime = value;
	            break;
	         case 3:
	        	 IFFurnaceTileEntity.this.cookTimeTotal = value;
	         }
	...
	protected IFFurnaceTileEntity(TileEntityType<?> tileTypeIn) {
		super(tileTypeIn, 4);
	...
	public void tick() {
		...
		if (!this.world.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				this.world.setBlockState(this.pos, this.world.getBlockState(this.pos).with(IFFurnaceBlock.LIT,
