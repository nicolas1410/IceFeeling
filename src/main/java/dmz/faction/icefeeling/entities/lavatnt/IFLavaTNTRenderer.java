...
@OnlyIn(Dist.CLIENT)
public class IFLavaTNTRenderer extends EntityRenderer<IFLavaTNTEntity> {
	
	private static final ResourceLocation LAVA_TNT_TEXTURE = new ResourceLocation(Main.MOD_ID + "block/ice_tnt");
	

    public IFLavaTNTRenderer(EntityRendererManager renderManager) {
        super(renderManager);
    }
