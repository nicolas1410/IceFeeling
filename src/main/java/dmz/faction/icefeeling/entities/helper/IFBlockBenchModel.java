package dmz.faction.icefeeling.entities.helper;
...
public class IFBlockBenchModel<T extends Entity> extends EntityModel<T>
{
	
	public IFBlockBenchModel() {
		super();
	}
	
	public IFBlockBenchModel(Function<ResourceLocation, RenderType> function) {
		super(function);
	}
