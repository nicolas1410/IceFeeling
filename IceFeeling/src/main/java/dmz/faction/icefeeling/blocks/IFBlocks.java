...
public class IFBlocks {
	...
	public static final RegistryObject<Block> ROBUSIUM_ORE = registerBlockWithDefaultItem("robusium_ore", () 
			-> new Block(AbstractBlock.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).setRequiresTool().harvestLevel(4).hardnessAndResistance(65, 1200)));
	
	public static final RegistryObject<IFRobusiumBlock> ROBUSIUM_BLOCK = registerBlockWithDefaultItem("robusium_block", () 
			-> new IFRobusiumBlock(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.BLACK).harvestTool(ToolType.PICKAXE).setRequiresTool().hardnessAndResistance(120, 9)));
